...
public class ConfigItems {
    ...
    public static void initItems(RegisterEvent.RegisterHelper<Item> event) {
        ...
        event.register("quicksilver", (ItemsTC.quicksilver = new ItemTCBase(new Item.Properties())));
        ...
        event.register("thaumium_pick", (ItemsTC.thaumiumPick = new PickaxeItem(ThaumcraftMaterials.TOOLMAT_THAUMIUM, 1, -2.8F, new Item.Properties().tab(ConfigItems.TABTC))));
        event.register("thaumium_hoe", (ItemsTC.thaumiumHoe = new HoeItem(ThaumcraftMaterials.TOOLMAT_THAUMIUM, -3, -0.5F, new Item.Properties().tab(ConfigItems.TABTC))));
