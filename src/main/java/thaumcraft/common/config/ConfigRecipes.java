...
public class ConfigRecipes extends RecipeProvider {
    ...
    public static void initializeAlchemyRecipes(Consumer<FinishedRecipe> pFinishedRecipeConsumer) {
        ...
        CrucibleRecipeBuilder.smelting(new ItemStack(ItemsTC.tallow)).research("HEDGEALCHEMY@1").catalyst(Items.ROTTEN_FLESH).aspects(new AspectList().merge(Aspect.FIRE, 1)).save(pFinishedRecipeConsumer, "thaumcraft:hedge_tallow");
        CrucibleRecipeBuilder.smelting(new ItemStack(Items.LEATHER)).research("HEDGEALCHEMY@1").catalyst(Items.ROTTEN_FLESH).aspects(new AspectList().merge(Aspect.AIR, 3).merge(Aspect.BEAST, 3)).save(pFinishedRecipeConsumer, "thaumcraft:hedge_leather");
        CrucibleRecipeBuilder.smelting(new ItemStack(Items.GUNPOWDER, 2)).research("HEDGEALCHEMY@2").catalyst(Items.GUNPOWDER).aspects(new AspectList(new ItemStack(Items.GUNPOWDER))).save(pFinishedRecipeConsumer, "thaumcraft:hedge_gunpowder");
        CrucibleRecipeBuilder.smelting(new ItemStack(Items.SLIME_BALL, 2)).research("HEDGEALCHEMY@2").catalyst(Items.SLIME_BALL).aspects(new AspectList(new ItemStack(Items.SLIME_BALL))).save(pFinishedRecipeConsumer, "thaumcraft:hedge_slime");
        CrucibleRecipeBuilder.smelting(new ItemStack(Items.GLOWSTONE_DUST, 2)).research("HEDGEALCHEMY@2").catalyst(Items.GLOWSTONE_DUST).aspects(new AspectList(new ItemStack(Items.GLOWSTONE_DUST))).save(pFinishedRecipeConsumer, "thaumcraft:hedge_glowstone");
        CrucibleRecipeBuilder.smelting(new ItemStack(Items.INK_SAC, 2)).research("HEDGEALCHEMY@2").catalyst(Items.INK_SAC).aspects(new AspectList(new ItemStack(Items.INK_SAC))).save(pFinishedRecipeConsumer, "thaumcraft:hedge_dye");
    ...
    public static void initializeNormalRecipes(Consumer<FinishedRecipe> pFinishedRecipeConsumer) {
        ...
        ShapedRecipeBuilder.shaped(ItemsTC.thaumiumShovel).group(thaumiumGroup.toString()).pattern("I").pattern("S").pattern("S").define('I', ItemsTC.thaumiumIngot).define('S', Items.STICK).unlockedBy("has_thaumium", has(ItemsTC.thaumiumIngot)).save(pFinishedRecipeConsumer);
        ShapedRecipeBuilder.shaped(ItemsTC.thaumiumPick).group(thaumiumGroup.toString()).pattern("III").pattern(" S ").pattern(" S ").define('I', ItemsTC.thaumiumIngot).define('S', Items.STICK).unlockedBy("has_thaumium", has(ItemsTC.thaumiumIngot)).save(pFinishedRecipeConsumer);
        ...
        ShapedRecipeBuilder.shaped(ItemsTC.thaumiumHoe).group(thaumiumGroup.toString()).pattern("II").pattern("S ").pattern("S ").define('I', ItemsTC.thaumiumIngot).define('S', Items.STICK).unlockedBy("has_thaumium", has(ItemsTC.thaumiumIngot)).save(pFinishedRecipeConsumer);
    ...
    public static void initializeSmelting(Consumer<FinishedRecipe> pFinishedRecipeConsumer) {
        ...
        MultiCookingRecipeBuilder.smelting(Ingredient.of(ItemsTC.clusterCopper), new ItemStack(Items.COPPER_INGOT, 2), 1.0f, 200).unlockedBy("has_cluster_copper", has(ItemsTC.clusterCopper)).group("cluster_copper").save(pFinishedRecipeConsumer, "thaumcraft:copper_ingot_from_smelting_cluster_copper");
        MultiCookingRecipeBuilder.blasting(Ingredient.of(ItemsTC.clusterCopper), new ItemStack(Items.COPPER_INGOT, 2), 1.0f, 100).unlockedBy("has_cluster_copper", has(ItemsTC.clusterCopper)).group("cluster_copper").save(pFinishedRecipeConsumer, "thaumcraft:copper_ingot_from_blasting_cluster_copper");
