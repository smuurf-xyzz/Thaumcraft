...
public class ItemTagsTC extends ItemTagsProvider {
    ...
    public static final TagKey<Item> GREATWOOD_LOGS = ItemTags.create(new ResourceLocation("thaumcraft", "greatwood_logs"));
    ...
    protected void addTags() {
        ...
        this.copy(BlockTagsTC.GREATWOOD_LOGS, ItemTagsTC.GREATWOOD_LOGS);
